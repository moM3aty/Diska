        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVerifiedMerchant = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MerchantPermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MerchantPermissions_AspNetUsers_MerchantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliverySlot = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionByAdminId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PendingMerchantActions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PendingMerchantActions_AspNetUsers_MerchantId",
                        column: x => x.MerchantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MerchantOffers_AspNetUsers_MerchantId",
                        column: x => x.MerchantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MerchantOffers_DealRequests_DealRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupDeals_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealRequests_UserId",
                table: "DealRequests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupDeals_CategoryId",
                table: "GroupDeals",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MerchantOffers_DealRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MerchantPermissions_MerchantId",
                table: "MerchantPermissions",
                column: "MerchantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PendingMerchantActions_MerchantId",
